...
workspace "Amazon Web Services Example" "An example AWS deployment architecture." do
  ...
  spring_pet_clinic = nil

  model do
    spring_pet_clinic = software_system "Spring PetClinic" "Allows employees to view and manage information regarding the veterinarians, the clients, and their pets.", "Spring Boot Application"
    ...
    web_application.point_to database, label: "Reads from and writes to", description: "JDBC/SSL"
  ...
  views do |view|
    ...
    view.theme "https://static.structurizr.com/themes/amazon-web-services-2020.04.30/theme.json"
  end
end
